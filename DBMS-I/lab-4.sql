...
INSERT INTO EMPLOTEE_MASTER(EMPNO,EMPNAME,JOININGDATE,SALARY,CITY) VALUES
...
SELECT * FROM EMPLOTEE_MASTER

--1. Delete all the records of Employee_MASTER table having salary greater than and equals to 14000.
	DELETE FROM EMPLOTEE_MASTER WHERE SALARY>=14000

--2. Delete all the Employees who belongs to ‘RAJKOT’ city.
	DELETE FROM EMPLOTEE_MASTER WHERE CITY='RAJKOT'

--3. Delete all the Employees who joined after 1-1-2007.
	DELETE FROM EMPLOTEE_MASTER WHERE JOININGDATE>'2007-1-1'

--4. Delete the records of Employees whose joining date is null and Name is not null.
	DELETE FROM EMPLOTEE_MASTER WHERE JOININGDATE IS NULL 

--5. Delete the records of Employees whose salary is 50% of 20000.
	DELETE FROM EMPLOTEE_MASTER WHERE SALARY = .5*20000

--6. Delete the records of Employees whose City Name is not empty.
	DELETE FROM EMPLOTEE_MASTER WHERE CITY IS NOT NULL

--7. Delete all the records of Employee_MASTER table. (Use Truncate)
	TRUNCATE TABLE EMPLOYEE_MASTER

--8. Remove Employee_MASTER table. (Use Drop)
	DROP TABLE EMPLOTEE_MASTER
